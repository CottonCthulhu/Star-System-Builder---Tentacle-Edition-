...
HotSubdwarf = {'Name': 'Hot Subdwarf', 'Planets': True, 'HZonePer': random.randint(7, 66), 'HZoneDist': random.randint(3, 13)}
...
class Star:
    def __init__(self):
        starTable = GetValueForNumber(Stellar_Body_Type, GetFudgeResult())
        self.name = GetValueForNumber(starTable, GetFudgeResult())['Name']
        self.spectralType = ""
